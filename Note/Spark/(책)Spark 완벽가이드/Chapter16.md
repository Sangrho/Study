...
아래와 같은 방식으로 시스템을 설정할 수 있다.
- 스파크 속성은 대부분의 어플리케이션 파라미터를 제어하며 SparkConf 객체를 사용해 스파크 속성을 설정할 수 잇다.
- 자바 시스템 속성
- 하드코딩된 환경 설정 파일
...
conf = SparkConf().setMaster("local[2]").setAppName("Josh")\
	.set("asdf","asdf")
```

어플리케이션, 런타임, 셔플, UI, 압축 및 시리얼라이제이션, 메모리 관리, 실행, 네트워킹, 스케줄링 설정은 아래를 참고하여 사용한다.

<h3><a id="user-content-application-properties" class="anchor" aria-hidden="true" href="#application-properties"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Application Properties</h3>
<table>
...
<pre><code>NOTE: Python memory usage may not be limited on platforms that do not support resource limiting, such as Windows.
</code></pre>
  </td>
</tr>
<tr>
...
<pre><code>NOTE: In Spark 1.0 and later this will be overridden by SPARK_LOCAL_DIRS (Standalone), MESOS_SANDBOX (Mesos) or
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/submitting-applications.html#master-urls"> allowed master URL's</a>.
  </td>
</tr>
<tr>
...
<h3><a id="user-content-runtime-environment" class="anchor" aria-hidden="true" href="#runtime-environment"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Runtime Environment</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<pre><code>&lt;br /&gt;&lt;em&gt;Note:&lt;/em&gt; In client mode, this config must not be set through the &lt;code&gt;SparkConf&lt;/code&gt;
directly in your application, because the driver JVM has already started at that point.
...
<pre><code>This is used in cluster mode only.
</code></pre>
  </td>
</tr>
<tr>
...
<pre><code>The following symbols, if present will be interpolated: {{APP_ID}} will be replaced by
...
<pre><code>By default the &lt;code&gt;pyspark.profiler.BasicProfiler&lt;/code&gt; will be used, but this can be overridden by
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/submitting-applications.html#advanced-dependency-management">Advanced Dependency Management</a>.
  </td>
</tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    found at <a href="http://ant.apache.org/ivy/history/latest-milestone/settings.html" rel="nofollow">Settings Files</a>
  </td>
</tr>
 <tr>
...
<h3><a id="user-content-shuffle-behavior" class="anchor" aria-hidden="true" href="#shuffle-behavior"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Shuffle Behavior</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/job-scheduling.html#configuration-and-setup">dynamic allocation
...
<h3><a id="user-content-spark-ui" class="anchor" aria-hidden="true" href="#spark-ui"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Spark UI</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    standard <a href="http://docs.oracle.com/javaee/6/api/javax/servlet/Filter.html" rel="nofollow">
    javax servlet Filter</a>.
<pre><code>&lt;br /&gt;Filter parameters can also be specified in the configuration, by setting config entries
...
<h3><a id="user-content-compression-and-serialization" class="anchor" aria-hidden="true" href="#compression-and-serialization"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Compression and Serialization</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    with Kryo.
    See the <a href="/Sangrho/spark/blob/v2.4.5/docs/tuning.html#data-serialization">tuning guide</a> for more details.
  </td>
</tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/api/scala/index.html#org.apache.spark.serializer.KryoRegistrator">
...
<tr>
  ...
  <td>
    ...
    but is quite slow, so we recommend <a href="/Sangrho/spark/blob/v2.4.5/docs/tuning.html">using
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/api/scala/index.html#org.apache.spark.serializer.Serializer">
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/tuning.html#memory-management-overview">this description</a>.
  </td>
</tr>
<tr>
...
<h3><a id="user-content-execution-behavior" class="anchor" aria-hidden="true" href="#execution-behavior"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Execution Behavior</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<pre><code>In standalone and Mesos coarse-grained modes, for more detail, see
...
<tr>
  ...
  <td>
    ...
    <a href="https://issues.apache.org/jira/browse/SPARK-6313" rel="nofollow">SPARK-6313</a> for more details).
  </td>
</tr>
<tr>
...
<tr>
    ...
    <a href="https://issues.apache.org/jira/browse/SPARK-2546" rel="nofollow">SPARK-2546</a> for more details).
...
<tr>
  ...
  <td>
    ...
    as per <a href="https://issues.apache.org/jira/browse/MAPREDUCE-4815" rel="nofollow">MAPREDUCE-4815</a>.
  </td>
</tr>
</tbody></table>
...
<pre><code>&lt;br /&gt;It also allows a different address from the local one to be advertised to executors or external systems.
...
<tr>
  ...
  <td>(not set)</td>
  <td>
    When running on a <a href="/Sangrho/spark/blob/v2.4.5/docs/spark-standalone.html">standalone deploy cluster</a> or a
    <a href="/Sangrho/spark/blob/v2.4.5/docs/running-on-mesos.html#mesos-run-modes">Mesos cluster in "coarse-grained"
...
<tr>
  ...
  <td>FIFO</td>
  <td>
    The <a href="/Sangrho/spark/blob/v2.4.5/docs/job-scheduling.html#scheduling-within-an-application">scheduling mode</a> between
...
<h3><a id="user-content-dynamic-allocation" class="anchor" aria-hidden="true" href="#dynamic-allocation"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Dynamic Allocation</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/job-scheduling.html#dynamic-resource-allocation">here</a>.
    <br><br>
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/job-scheduling.html#resource-allocation-policy">description</a>.
  </td>
</tr>
<tr>
...
<p>Please refer to the <a href="/Sangrho/spark/blob/v2.4.5/docs/security.html">Security</a> page for available options on how to secure different
Spark subsystems.</p>
<h3><a id="user-content-spark-sql" class="anchor" aria-hidden="true" href="#spark-sql"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Spark SQL</h3>
<p>Running the <code>SET -v</code> command will show the entire list of the SQL configuration.</p>
<div>
<div>
<p>{% highlight scala %}
...
<h1><a id="user-content-spark-is-an-existing-sparksession" class="anchor" aria-hidden="true" href="#spark-is-an-existing-sparksession"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>spark is an existing SparkSession</h1>
<p>spark.sql("SET -v").show(n=200, truncate=False)
{% endhighlight %}</p>
</div>
<div>
<p>{% highlight r %}
...
<h3><a id="user-content-spark-streaming" class="anchor" aria-hidden="true" href="#spark-streaming"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>Spark Streaming</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/streaming-programming-guide.html#level-of-parallelism-in-data-receiving">performance
...
<tr>
  ...
  <td>
    ...
    See the <a href="/Sangrho/spark/blob/v2.4.5/docs/streaming-programming-guide.html#deploying-applications">deployment guide</a>
...
<tr>
  ...
  <td>
    ...
    <a href="/Sangrho/spark/blob/v2.4.5/docs/streaming-kafka-integration.html">Kafka Integration guide</a>
    for more details.
  </td>
</tr>
<tr>
...
<h3><a id="user-content-sparkr" class="anchor" aria-hidden="true" href="#sparkr"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>SparkR</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
...
<h3><a id="user-content-graphx" class="anchor" aria-hidden="true" href="#graphx"><svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4 9h1v1H4c-1.5 0-3-1.69-3-3.5S2.55 3 4 3h4c1.45 0 3 1.69 3 3.5 0 1.41-.91 2.72-2 3.25V8.59c.58-.45 1-1.27 1-2.09C10 5.22 8.98 4 8 4H4c-.98 0-2 1.22-2 2.5S3 9 4 9zm9-3h-1v1h1c1 0 2 1.22 2 2.5S13.98 12 13 12H9c-.98 0-2-1.22-2-2.5 0-.83.42-1.64 1-2.09V6.25c-1.09.53-2 1.84-2 3.25C6 11.31 7.55 13 9 13h4c1.45 0 3-1.69 3-3.5S14.5 6 13 6z"></path></svg></a>GraphX</h3>
<table>
<tbody><tr><th>Property Name</th><th>Default</th><th>Meaning</th></tr>
<tr>
